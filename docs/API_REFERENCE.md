...
The lilbro-whisper service provides a RESTful HTTP API for semantic search across transcribed audiobook content. The API uses vector embeddings to find relevant content chunks based on natural language queries.
